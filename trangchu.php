...
<body>
	<div class="tong">
		...
		<?php
		 ...
		 ?>
			<div class="sp">
            	<h3><?php echo $row['ten_theloai']; ?></h3>
                <div class="book">
                	<?php
                		$sach = sach_theloai($row['id_theloai']);
                		while ($book = mysqli_fetch_array($sach))
                		{
                	 ?>
                        <div class="book1">
                         	<a href="sanpham.php?idsach=<?php echo $book['id_sach']; ?>"><img src="img/<?php echo $book['hinhanh']; ?>" width="270px" height="364px"></a>
                            <p><?php echo $book['tensach']; ?></p>
                            <span><?php echo $book['dongia']; ?> đ</span>
                        </div>
                     <?php } ?>
              	</div>
   				<a href="theloai.php?idtl=<?php echo $row['id_theloai']; ?>" class="xemthem">Xem thêm</a>
             </div>
             <?php } ?>
        </div>
